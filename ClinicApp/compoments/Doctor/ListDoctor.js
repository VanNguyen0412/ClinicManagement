...
import { View, Text, StyleSheet, ScrollView, TextInput, Image, TouchableOpacity, Modal } from 'react-native';
...
const ListDoctor = () => {
    ...
    const loadDoctor = async () => {
        ...
        try{
            ...
            setDoctor(res.data);
            if (data.length > 0) {
                setSelectedSpecialty(data[0].expertise); // Chọn chuyên khoa đầu tiên làm mặc định
            }
